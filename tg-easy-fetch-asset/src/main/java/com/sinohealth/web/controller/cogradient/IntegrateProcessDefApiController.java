...
import com.sinohealth.common.enums.CommandType;
import com.sinohealth.common.enums.FailureStrategy;
import com.sinohealth.common.enums.Priority;
import com.sinohealth.common.enums.RunMode;
import com.sinohealth.common.enums.TaskDependType;
import com.sinohealth.common.enums.WarningType;
...
@RestController
@RequestMapping("/api/integrate/process")
public class IntegrateProcessDefApiController extends BaseController {
    ...
    public AjaxResult createProcessDefinition(
        ...
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.createProcessDefinition(id, tableId, name, json, crontab, locations, connects, releaseState, processId -> {
        }));
    }
    ...
    public AjaxResult releaseProcessDefinition(
        ...
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.release(id, releaseState));
    }

    @GetMapping(value = "/releaseByProcessId")
    @ResponseStatus(HttpStatus.OK)
    public AjaxResult releaseByProcessId(@RequestParam(value = "id") Integer id,
                                         @RequestParam(value = "releaseState") Integer releaseState) {
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.releaseByProcessId(id, releaseState));
    }
    ...
    public AjaxResult queryDataSourceListPaging(
        ...
        return intergrateProcessDefService.wrapException(() -> AjaxResult.success(intergrateProcessDefService.queryListPaging(page, searchVal)));
    }
    ...
    public AjaxResult startProcessInstance(
        ...
        postParameters.add("warningGroupId", appProperties.getFinalWarnGroupId(warningGroupId));
        ...
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.execProcessInstance(postParameters));
    ...
    public AjaxResult deleteProcessDefinitionById(@RequestParam("id") Integer id) {
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.delete(id));
    }
    ...
    public AjaxResult syncDetail(
            ...
            @RequestParam("pageNo") Integer pageNo,
            @RequestParam("pageSize") Integer pageSize) {
        return intergrateProcessDefService.wrapException(() -> AjaxResult.success(intergrateProcessDefService.querySyncDetail(id, tableId, state, pageNo, pageSize)));
    }
    ...
    public AjaxResult monitorDetail(@RequestParam(value = "startTime", required = false) String startTime,
        ...
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.countTaskState(startTime, endTime));
    }
    ...
    public AjaxResult queryLog(
        ...
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.queryLog(taskInstanceId, skipNum, limit));
    }
    ...
    public AjaxResult queryProcessDefinitionList(
        ...
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.queryProcessDefinitionList(pageNo, pageSize, searchVal, releaseState));
    }

    @GetMapping(value = "/queryById")
    @ApiOperation("分页查询流程列表")
    public AjaxResult queryProcessDefinitionById(@RequestParam(value = "processId") Integer processId) {
        return intergrateProcessDefService.wrapException(() -> intergrateProcessDefService.queryProcessById(processId));
    }
