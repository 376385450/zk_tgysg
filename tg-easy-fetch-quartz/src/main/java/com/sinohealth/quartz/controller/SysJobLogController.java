package com.sinohealth.quartz.controller;
...
import com.sinohealth.quartz.domain.SysJobLog;
import com.sinohealth.quartz.service.ISysJobLogService;
 ...
 */
@RestController
@RequestMapping({"/monitor/jobLog","/api/monitor/jobLog"})
