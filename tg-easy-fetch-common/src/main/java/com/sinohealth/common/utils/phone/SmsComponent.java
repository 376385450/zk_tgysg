...
//    String appSecret = "q4Ii87BhST9vcs8wvrzN80SfD7Al"; //APP_Secret
    ...
    public Integer sendSms(String signature, String receiver, String ... params) throws Exception {
        Integer status = null;
        ...
        String templateParas = sb.toString(); //模板变量，此处以单变量验证码短信为例，请客户自行生成6位验证码，并定义为字符串类型，以杜绝首位0丢失的问题（例如：002569变成了2569）。
