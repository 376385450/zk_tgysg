...
import com.sinohealth.common.core.text.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static <R> List<R> toList(String str, Function<String, R> mapper) {
    ...
    public static <T> String joinNames(List<T> idList, Map<T, String> nameMap, String delimiter) {
