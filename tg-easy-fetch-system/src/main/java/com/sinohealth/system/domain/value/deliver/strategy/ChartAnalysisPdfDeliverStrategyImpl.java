...
public class ChartAnalysisPdfDeliverStrategyImpl implements ResourceDeliverStrategy<CharAnalysisDataSource, PdfResource> {
    ...
    @Override
    public PdfResource deliver(CharAnalysisDataSource dataSource) throws Exception {
