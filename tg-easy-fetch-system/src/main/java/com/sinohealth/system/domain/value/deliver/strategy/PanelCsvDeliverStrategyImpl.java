...
public class PanelCsvDeliverStrategyImpl implements ResourceDeliverStrategy<PanelDataSource, CsvResource> {
    ...
    @Override
    public CsvResource deliver(PanelDataSource dataSource) throws Exception {
