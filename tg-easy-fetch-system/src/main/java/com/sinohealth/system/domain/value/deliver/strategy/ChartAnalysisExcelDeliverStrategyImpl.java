...
public class ChartAnalysisExcelDeliverStrategyImpl implements ResourceDeliverStrategy<CharAnalysisDataSource, ExcelResource> {
    ...
    @Override
    public ExcelResource deliver(CharAnalysisDataSource dataSource) throws Exception {
