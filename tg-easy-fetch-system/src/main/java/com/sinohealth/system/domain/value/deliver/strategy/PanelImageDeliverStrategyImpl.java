...
public class PanelImageDeliverStrategyImpl implements ResourceDeliverStrategy<PanelDataSource, ImageResource> {
    ...
    @Override
    public ImageResource deliver(PanelDataSource dataSource) throws Exception {
