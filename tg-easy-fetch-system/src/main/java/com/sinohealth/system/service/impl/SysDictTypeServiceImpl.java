...
import com.sinohealth.common.core.domain.entity.SysDictType;
import com.sinohealth.common.exception.CustomException;
import com.sinohealth.common.utils.DictUtils;
import com.sinohealth.common.utils.StringUtils;
import com.sinohealth.system.mapper.SysDictDataMapper;
import com.sinohealth.system.mapper.SysDictTypeMapper;
...
public class SysDictTypeServiceImpl extends ServiceImpl<SysDictTypeMapper, SysDictType> implements ISysDictTypeService {
     ...
     */
    @Override
    public List<SysDictData> selectDictDataByType(String dictType, String searchContent) {
        String key = dictType + ":" + searchContent;
        ...
        dictDatas = dictDataMapper.selectList(new LambdaQueryWrapper<SysDictData>()
                ...
                .like(StringUtils.isNotBlank(searchContent), SysDictData::getDictLabel, searchContent)
                .orderByAsc(SysDictData::getDictSort));
        if (CollUtil.isNotEmpty(dictDatas)) {
