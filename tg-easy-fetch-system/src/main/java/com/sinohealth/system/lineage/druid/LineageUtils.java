package com.sinohealth.system.lineage.druid;
...
import com.sinohealth.system.lineage.common.EmptyUtils;
...
public class LineageUtils {
    ...
    public static void columnLineageAnalyzer(String sql, TreeNode<LineageColumn> node) {
        ...
        if(statement instanceof  SQLCreateTableStatement){
            SQLCreateTableStatement sqlSelectStatement = (SQLCreateTableStatement) statement;
            sqlSelectQuery = sqlSelectStatement.getSelect().getQuery();
     ...
     * @param table
     */
    private static void handlerSQLUnionQueryTableSource(TreeNode<LineageColumn> node,
     ...
     * @param table
     */
    private static void handlerSQLSubqueryTableSource(TreeNode<LineageColumn> node,
    ...
    private static void handlerSQLExprTableSource(TreeNode<LineageColumn> node,
        ...
        String db = tableSource.getExpr() instanceof SQLPropertyExpr ? ((SQLPropertyExpr)
                tableSource.getExpr()).getOwner().toString().replace("`", "") : "";
        String tableName = tableSource.getExpr() instanceof SQLPropertyExpr ? ((
                SQLPropertyExpr) tableSource.getExpr()).getName().replace("`", "") : "";
        ...
        node.getChildren().forEach(e ->
        {
            e.getChildren().forEach(f -> {
                ...
                if (f.getData().getSourceTableName() == null || f.getData().getSourceTableName().equals(tableName) || f
