...
public class ExpressionTest {
    ...
    public void testBuildV2() throws Exception {
        Map<String, String> nameMap = new HashMap<>();
        nameMap.put("11", "SUM(`放大销售额　`)");
        nameMap.put("10", "SUM(`放大销售量　`)");

        Optional<String> fOpt;

        fOpt = ApplicationSqlUtil.buildFormula("{11}/{10}", nameMap, null, DivisorModeEnum.zero_result.name());
        fOpt.ifPresent(System.out::println);
